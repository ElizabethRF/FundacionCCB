...
ActiveRecord::Schema.define(version: 20170419225707) do
  ...
  create_table "respuestazos", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "respuesta"
    t.string   "valor"
    t.datetime "fecha"
    t.string   "num_pregunta"
    t.string   "integer"
  end
